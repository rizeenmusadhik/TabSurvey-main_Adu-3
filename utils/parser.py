...
def get_parser():
    ...
    parser.add('--lr_milestones', type=str, default='150,225', help='Milestones for learning rate decay (default: 150,225)')
    parser.add('--lr_f', type=float, default=0.1, help='Scaling factor for learning rate (default: 0.1)')
    parser.add('--momentum', type=float, default=0.9, help='Momentum for SGD (default: 0.9)')

    parser.add('--weight-decay', '--wd', type=float, default=1e-4, metavar='W', help='Weight decay (default: 1e-4)')
    parser.add_argument("--result_dir", type=str, default="./results/dynamic_net", help="Directory to save model results")
